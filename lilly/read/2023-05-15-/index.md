...
- [SQL Training](https://speakerdeck.com/ymiyake/sql-training-2021)
- [生成 AI 時代における UX デザイン | 生成 AI をフル活用した UX 設計手法＆生成 AI 時代のユーザー体験の変化について](https://speakerdeck.com/kajikent/sheng-cheng-aishi-dai-niokeruuxdezain)

## 👀 読んだ

- [ロジカルなコミットメッセージの書き方](https://zenn.dev/mi0256/articles/1332e1d041cab4)
- [【React】爆速コーディングが捗る自作スニペットのすすめ](https://zenn.dev/yhase_rqp/articles/9f078de0e830ff)
- [AI 技術を活用した WEB デザイン：ChatGPT と Midjourney の活用例](https://developer.so-tech.co.jp/entry/2023/05/08/120000)
- [React で 3D 表現！react-three-fiber を使ってみよう](https://tamalog.szmd.jp/react-three-fiber/)
- [TypeScript と React/Next.js でつくる 実践 Web アプリケーション開発](https://gihyo.jp/book/2022/978-4-297-12916-3)
- [GitHub Copilot chat が解禁されたので使ってみての感想と ChatGPT と比べてどうかの所感](https://qiita.com/AKB428/items/48fa5014b10052c05a45)
- [令和時代の CSS 記法再考](https://zenn.dev/okamoai/articles/ae39b3838d1b75)
...
- [CSR/SSR/SSG はどう選べば良いのか](https://qiita.com/shiro_kzy/items/d85b9d140dd8772194e1)
- [【React】もっとデカルトみを感じたい ―― イベントの処理を親子で適切に分担する](https://qiita.com/honey32/items/64435d17bfaa2cb10b88)
- [自社開発メガベンチャーをわずか半年で鬱退職した雑魚エンジニアの話](https://zenn.dev/joanofarc/articles/depressied_fired_engineer_on_mega_venture)
- [【備忘録】Next.js 開発環境を Docker で構築(WSL2)](https://qiita.com/KMNMKT/items/4837f123b30bcf7003c7)
- [ざっくりつかむ！LangChain のメンタルモデル](https://zenn.dev/fumi_sagawa/articles/113b4e5a46b984)
- [だから僕は tailwind css を使いたくない。tailwind のしんどいところと emotion との比較](https://zenn.dev/saltedlemon/articles/2e16ec10404f2d)
- [Web 制作用の Astro テンプレートを公開しました](https://foolish-pine.com/posts/2023/03/static-site-boilerplate-astro)
...
- 5/17 PWA Night vol.51 ～ AI × フロントエンド開発〜
- 5/25 Generative AI 時代の UX デザイン
- 5/31 microCMS Online Meetup 2023
